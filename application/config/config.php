...
$config['cron_token'] = 'ihpDkM2pSTwfYmnZ';

/*
|--------------------------------------------------------------------------
| Google Gemini AI Settings
|--------------------------------------------------------------------------
| ค่าเริ่มต้นสำหรับระบบ AI วิเคราะห์ธุรกิจ (สามารถตั้งค่าผ่านหน้าเว็บได้)
*/
$config['gemini_api_key'] = getenv('GEMINI_API_KEY') ?: '';
$config['gemini_model']   = getenv('GEMINI_MODEL') ?: 'gemini-3.6-flash';
